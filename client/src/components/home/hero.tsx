      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white">
            Your <span className="text-highlight-text">Choices</span> Shape Your
            Journey
          </h1>
          ...
          <div className="flex items-center gap-8 md:gap-3 mt-8">
            ...
            <span className="text-tertiary-text">
              Join all the people who took the quiz today
            </span>
          </div>
        </div>
        <div className="flex-1">
          <div className="bg-background-accent rounded-xl p-4 shadow-xl">
